...
int menuOption()
{
	...
	cout << "\t" << char(186) << "   1: Create a min/max heap using vector STL      " << char(186) << "\n";
	cout << "\t" << char(186) << "   2: Simulate uniion and intersect of heaps      " << char(186) << "\n";
	cout << "\t" << char(186) << "   3: STL and algorithm Heap                      " << char(186) << "\n";
